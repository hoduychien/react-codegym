...
const ModalEditBook = (props) => {
    const formik = useFormik({
        initialValues: {
            ...
            quantity: props.selectedBook.quantity,
            status: props.selectedBook.status,
            desc: props.selectedBook.desc,
        },

        onSubmit: async (values) => {
            const { title, author, price, quantity, status, desc } = values;
            const data = {
                title,
                author,
                price,
        ...
        >
            <div className="modal-create">
                <div className="modal-create-heading">
                    <h3 className="modal-create-heading-tittle">Update Book {props.selectedBook.title}</h3>
                ...
                <form className="modal-create-form" onSubmit={formik.handleSubmit}>
                    ...
                    <div className="modal-create-form-item">
                        <div className="modal-create-form-button" onClick={props.handleOpen}>
                            Cancel
                        </div>
